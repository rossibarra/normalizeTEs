...
[sample_age_matched_syn.py:191](sample_age_matched_syn.py#L191):
...
[sample_age_matched_syn.py:248](sample_age_matched_syn.py#L248). The cache is therefore built
...
([line 171](sample_age_matched_syn.py#L171), [line 237](sample_age_matched_syn.py#L237),
`_BlockCache.__init__` at [line 136](sample_age_matched_syn.py#L136)) is smaller than the block
...
[build_snp_age_store.py:151](build_snp_age_store.py#L151):
...
**Cache lifetime.** `grep -n "_BlockCache(" sample_age_matched_syn.py` — the single
