...
expand `normalize_tes/sample_age_matched_syn.py` into a combined builder/sampler.
...
Add `normalize_tes/sample_age_matched_controls.py` and retain
`normalize_tes/sample_age_matched_syn.py` as a compatibility entry point until migration is
