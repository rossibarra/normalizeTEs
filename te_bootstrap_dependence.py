...
`te_age_target.py` bootstraps TE sites with an iid multinomial draw, and the
...
from sample_age_matched_controls import _load_target
from snp_age_store import open_snp_age_store
from swap_control_sampler import analysis_points, row_cdfs
